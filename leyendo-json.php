...
<?php for($n = 0; $n < $todos; $n++){?>
  ...
  <li>El Smart Citizen Kit <?php echo($datos[$n]['id']);?> está <?php echo('instalado en '.$datos[$n]['city']);?> (<a href="https://www.google.cl/maps/place/<?php echo($datos[$n]['latitude'].','.$datos[$n]['longitude']);?>" rel="nofollow" target="_blank">Ver ubicación en Google Maps</a>, <a href="leyendo-json-extra.php?url=https://api.smartcitizen.me/v0/devices/<?php echo($datos[$n]['id']);?>.json">Ver detalles</a>).</li>
